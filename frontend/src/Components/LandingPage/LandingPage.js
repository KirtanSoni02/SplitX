    ...
    <>
    {
      ...
      <nav className='navBar'>
        <div className='navBarLeftChild'>
          ...
          <li><a href="https://mail.google.com/mail/?view=cm&to=sonikirtan968@gmail.com" target='blank'>Contact Us</a></li>
        </div>
      ...
      <footer className='footerSmall'>
        Made with ❤️ by Kirtan Soni. All rights reserved. Copyright &copy; {year} 
      </footer>
    </>
  )
}
